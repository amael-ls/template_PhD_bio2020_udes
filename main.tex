...
\usepackage{csquotes}
\usepackage[uniquelist=false, backend=biber, citestyle=authoryear-comp, sorting=ynt, giveninits=true, hyperref, natbib, url=false, doi=false, eprint=false, isbn=false, maxbibnames=25, maxcitenames=1, mincitenames=1]{biblatex}
